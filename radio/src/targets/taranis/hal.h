...
// Keys
...
#elif defined(RADIO_TX12) || defined(RADIO_TX12MK2) || defined(RADIO_BOXER) || defined(RADIO_POCKET)
  ...
  // #define KEYS_GPIO_REG_BIND
  // #define KEYS_GPIO_PIN_BIND
...
// Rotary Encoder
  ...
  #endif
  #if defined(RADIO_TX12MK2) || defined(RADIO_BOXER) || defined(RADIO_ZORRO) || defined(RADIO_POCKET)
...
// Switches
  ...
  #define SWITCHES_GPIO_PIN_A_L         LL_GPIO_PIN_13  // PC.13
  #define SWITCHES_GPIO_REG_A_H         GPIOA
  #define SWITCHES_GPIO_PIN_A_H         LL_GPIO_PIN_8  // PA.8
#elif defined(RADIO_T8)
  #define STORAGE_SWITCH_A
  #define HARDWARE_SWITCH_A
...
#elif (RADIO_LR3PRO || defined (RADIO_ZORRO))
  #define STORAGE_SWITCH_B
  #define HARDWARE_SWITCH_B
  #define SWITCHES_GPIO_REG_B_L         GPIOE
  ...
  #define HARDWARE_SWITCH_D
  #define SWITCHES_GPIO_REG_D_L         GPIOE
  #define SWITCHES_GPIO_PIN_D_L         LL_GPIO_PIN_8  // PE.08
  #define SWITCHES_GPIO_REG_D_H         GPIOC
  #define SWITCHES_GPIO_PIN_D_H         LL_GPIO_PIN_8  // PC.08
#elif defined(RADIO_TLITE) || defined(RADIO_TPRO) || defined(RADIO_TPROV2) || defined(RADIO_LR3PRO)
  #define STORAGE_SWITCH_D
  #define HARDWARE_SWITCH_D
  #define SWITCHES_GPIO_REG_D           GPIOD
...
#elif defined(PCBX7) || defined(PCBXLITE) || defined(PCBX9LITE)  || defined(RADIO_T8) || defined(RADIO_COMMANDO8) || defined(RADIO_POCKET)
  // no SWG
#else
  #define STORAGE_SWITCH_G
  #define HARDWARE_SWITCH_G
...
// X7 P400 P401 headers additionnal momentary switches
  ...
  #define HARDWARE_SWITCH_I
  #define SWITCHES_GPIO_REG_I           GPIOC
  #define SWITCHES_GPIO_PIN_I           LL_GPIO_PIN_9 // PC.9
  #define STORAGE_SWITCH_J
  #define HARDWARE_SWITCH_J
  #define SWITCHES_GPIO_REG_J           GPIOB
  #define SWITCHES_GPIO_PIN_J           LL_GPIO_PIN_2  // PB.02
#elif defined(RADIO_TPROV2)
  // SW1
...
// External Module
#if defined(PCBXLITE) || defined(PCBX9LITE) || defined(RADIO_X9DP2019) || defined(PCBX7ACCESS) || defined(RADIO_ZORRO) || defined(RADIO_POCKET) || defined(RADIO_TX12MK2) || defined(RADIO_BOXER)
  #if defined(RADIO_X9DP2019) || defined(RADIO_X7ACCESS) || defined(RADIO_ZORRO)|| defined(RADIO_POCKET) || defined(RADIO_TX12MK2) || defined(RADIO_BOXER)
...
#elif defined(PCBXLITE) || defined(RADIO_ZORRO)
  #define TRAINER_TIMER                 TIM4
...
// S.Port update connector
  ...
  #define GPIO_SPORT_UPDATE_PWR_GPIO_ON  GPIO_SetBits
  #define GPIO_SPORT_UPDATE_PWR_GPIO_OFF GPIO_ResetBits
#elif defined(RADIO_X7) || !defined(RADIO_ZORRO)
...
// Trainer / Trainee from the module bay
    ...
    defined(PCBX7ACCESS) || defined(RADIO_ZORRO) || defined(RADIO_POCKET) || defined(RADIO_TX12MK2) || defined(RADIO_BOXER)
...
// LCD driver
#if defined(RADIO_TX12) || defined(RADIO_TX12MK2) || defined(RADIO_BOXER) || defined(RADIO_ZORRO) || defined(RADIO_POCKET) || defined(RADIO_FAMILY_JUMPER_T12) || defined(RADIO_T8) || defined(RADIO_COMMANDO8) || defined(RADIO_TPRO) || defined(RADIO_TPROV2) || defined(RADIO_T20)
  #define LCD_VERTICAL_INVERT
#endif
#if defined(RADIO_LR3PRO) || defined(RADIO_TPROV2) || defined(RADIO_T20) || defined(RADIO_ZORRO)
...
// Haptic
#if defined(PCBXLITE) || defined(PCBX9LITE) || defined(RADIO_ZORRO) || defined(RADIO_POCKET) || defined(RADIO_TX12MK2)|| defined(RADIO_BOXER)
  #define HAPTIC_PWM
